...
public interface StockOrderDao {
    ...
    int deOrder(Integer status);

    int countOrderStatus(Integer status);
     ...
     * @return
     */
    List<StockOrder> getOrderByTime();

    /**
     * 根据订单id修改订单状态
     */
    int updateOrderStatusById(Integer orderId, Integer statusId);
}